import { SuperChats as Base } from './send_messages';
import { WAMessageKey, MessageInfo, WAMessage, WAMessageProto, ChatModification, WAChatIndex } from './variables';
export declare class SuperChats extends Base {
    sendText(id: string, text: string, replyIdMessage?: string): Promise<{}>;
    sendLink(id: string, link: string, description?: string, replyIdMessage?: string): Promise<{}>;
    sendImage(id: string, file: string, text?: string, replyIdMessage?: string): Promise<{}>;
    ...
    sendGif(id: string, file: string, replyIdMessage?: string): Promise<{}>;
    sendList(id: string, btnName: string, section: string, rows: any, description?: string, replyIdMessage?: string): Promise<{}>;
    sendButtons(id: string, title: string, buttons: any, description?: string, replyIdMessage?: string): Promise<{}>;
     ...
     * @param forceForward will show the message as forwarded even if it is from you
     */
    forward(jid: string, message: WAMessage, forceForward?: boolean): Promise<WAMessageProto.WebMessageInfo>;
    /**
    ...
    protected modifyMessages(response: any): Promise<{}>;
    sendTextStatus(text: string): Promise<{}>;
    sendImageStatus(file: string, text?: string): Promise<{}>;
    sendVideoStatus(file: string, text?: string): Promise<{}>;
    deleteStatus(messageId: string): Promise<{}>;
    pushInfoFile(file: any): {
        fileName: any;
    };
}
