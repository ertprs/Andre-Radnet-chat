...
import { WA } from '../sys/vars';
import { proto } from '../lib/wapi/wapi';
import { Agent } from 'https';
import FluidDB from '../db/FluidDB';
import { URL } from 'url';
...
export declare type WARequestPayment = proto.RequestPaymentMessage;
...
export declare class Erros extends Error {
    status?: number;
    context: any;
    constructor(message: string, context: any, stack?: string);
}
export declare const TimedOutError: (stack?: string) => Erros;
export declare const CancelledError: (stack?: string) => Erros;
...
export declare type WAConnectOptions = {
    /** name of session venom live */
    sessionName?: string;
    /** key license */
    license?: string;
    /** name of device */
    deviceName?: string;
    /** number of phone connected */
    phoneNumber?: string;
    /** url for decrypt remote */
    decryptUrl?: string;
...
export declare type createState = 'open' | 'connecting' | 'close';
...
export interface WAChat {
    ...
    ephemeral?: string;
    messages: FluidDB<WAMessage, string>;
    imgUrl?: string;
    presences?: {
...
export declare type WPEvent = 'open' | 'connecting' | 'close' | 'ws-close' | 'qr' | 'connection-phone-change' | 'contacts-received' | 'chats-received' | 'initial-data-received' | 'chat-new' | 'chat-update' | 'group-participants-update' | 'group-update' | 'received-pong' | 'blocklist-update' | 'contact-update';
